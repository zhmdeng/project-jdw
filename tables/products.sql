...
create table if not exists products(
	...
	product_id bigint(20) not null default 000000 comment "产品ID",
	outer_id bigint(20) not null default 000000 comment "外部产品ID",
...
) engine=InnoDB AUTO_INCREMENT = 55726 default charset=utf8mb4 COMMENT = '产品';