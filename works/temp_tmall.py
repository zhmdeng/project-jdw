...
if __name__ == '__main__':
    ...
    try:
            ...
            order = f"""
                    select * from wms.orders where port = '天猫' -- and title = ""
                    """
            ...
            '物流单号 ','宝贝总数量','修改后的sku','发货时间','物流公司','title']]
            ...
            'sid','num','sku_id','consign_time','shipping_company_name','title']
            ...
            for i in range(len(final_data)):
                ...
                if final_data['title'][i] == "Doctor's Best":
                    final_data['store'] = 'doctorsbest海外旗舰店'
                elif final_data['title'][i] == "Zipfizz":
                    final_data['store'] = 'ZIPFIZZ海外旗舰店'
                elif final_data['title'][i] == "MAIKON":
                    final_data['store'] = '舞昆海外旗舰店'
                else:
                    continue
